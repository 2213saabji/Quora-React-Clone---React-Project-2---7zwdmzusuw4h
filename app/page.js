        ...
        {data && data.map((item,index) => (
          <div className={` brdr-r3 mt10 ${themecheck("bkwhite", "bklightblack")}`}>
            ...
            <div className={`flex pl20 pr20 pb5 mt5`}>
              <div className={`brdr-r50 csrpntr flex brdr1 ${themecheck("brdrlightgray", "brdrllgray")} `}><p className={`flexa bghvr brdrr1 upvotebtn pt5 pl10 pr10 pb5 fnt13 ${themecheck("brdrlightgray", "brdrllgray")}`}>{upvoteicon}&nbsp;Upvote . &nbsp;{item.likeCount}</p><p className={`pl10 pr10  bghvr downvotebtn flexja`}>{downvoteicon}</p></div>
